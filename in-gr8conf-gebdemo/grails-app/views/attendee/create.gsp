...
<html>
    ...
    <g:form action="save">
	    ...
	    <fieldset class="well">
		    <button class="btn btn-primary" type="submit" value="${message(code: 'default.button.create.label', default: 'Create')}"><span class="glyphicon glyphicon-save" aria-hidden="true"></span> <g:message code="default.button.create.label" default="Delete"/></button>
	    </fieldset>
    </g:form>
    </body>
</html>
